...
import com.maku.dating.ui.util.Messages;
...
public class MessagesRecyclerViewAdapter extends RecyclerView.Adapter<MessagesRecyclerViewAdapter.ViewHolder> implements Filterable {
    ...
    @NonNull
    @Override
    public MessagesRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MessagesRecyclerViewAdapter.ViewHolder holder, final int position) {
